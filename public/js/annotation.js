...
function showValueAnnotation(element) {
  ...
  btcreateEventUser.setAttribute(
    "onclick",
    `saveTextAnnotation('${elem.key}');`
  );

  bodyModal.innerHTML = `
    <textarea class='textAreaAnnotation' id='idTextAreaAnnotation' rows='10' placeholder="Anote aqui">${
