...
function filtroDeEventos() {
  // retornara qual o filtro aplicado - retornara um objet(tipo,dia,mes,ano)
  let type = 0;
...
var audio = new Audio(
  "https://firebasestorage.googleapis.com/v0/b/agende-se-116d9.appspot.com/o/notificationEvent.mp3?alt=media&token=e23679ef-8cac-4bd3-a614-87a0d83e6ecd"
);
